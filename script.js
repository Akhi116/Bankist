...
const account1 = {
  ...
  movementsDates: [
    ...
    '2020-07-29T14:11:59.604Z',
    '2020-08-05T17:01:17.194Z',
    '2020-08-03T23:36:17.929Z',
...
const formatMovementDate = (date, locale) => {
  ...
  const daysPassed = days(new Date('Aug 2,2020'), date);
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // when 0 second, stop time and log out
  };
...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    alert('Please re-check the balance or transfer To');
  }
});
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    ...
    alert('Movements should contain atleast 10% of amount');
  }
